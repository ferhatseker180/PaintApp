...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageButtonBrush = findViewById<ImageButton>(R.id.imageButton_brush)
        ...
        val ibGallery : ImageButton = findViewById(R.id.imageButton_gallery)

        ibGallery.setOnClickListener {
            requestStoragePermission()
        }

        val imageButtonUndo = findViewById<ImageButton>(R.id.imageButton_undo)
        imageButtonUndo.setOnClickListener {
            drawingView?.onClickUndo()
        }

        val imageButtonSave = findViewById<ImageButton>(R.id.imageButton_save)
    ...
    private fun requestStoragePermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this@MainActivity,android.Manifest.permission.READ_EXTERNAL_STORAGE)) {
            showRationaleDialog("DrawingApp","Drawing App"+"needs to Access Your External Storage")
        }
        else {
    ...
    private fun showBrushSizeChooserDialog() {
        ...
        val smallButton = brushDialog.findViewById<ImageButton>(R.id.imageButton_small_brush)
      //  val smallButton = brushDialog.imageButton_small_brush
        ...
        val mediumButton = brushDialog.findViewById<ImageButton>(R.id.imageButton_medium_brush)
       ...
       val largeButton = brushDialog.findViewById<ImageButton>(R.id.imageButton_large_brush)
    ...
    fun paintClicked(view: View) {
        if (view !== mImageButtonCurrentPaint) {
            ...
            imageButton.setImageDrawable(ContextCompat.getDrawable(this@MainActivity,R.drawable.pallet_pressed))

            mImageButtonCurrentPaint?.setImageDrawable(ContextCompat.getDrawable(this@MainActivity,R.drawable.pallet_normal))
